                    ...
                    <div class="offcanvas offcanvas-end text-bg-dark" tabindex="-1" id="offcanvasNavbar"
                        ...
                        <div class="offcanvas-body d-flex flex-lg-row flex-column align-items-lg-center ">
                            ...
                            <ul class="navbar-nav text-center mb-3 mb-lg-0 mx-lg-auto align-items-lg-center">
                                ...
                                <li class="nav-item px-lg-3"><a class="nav-link" href="http://localhost/SAE/TableaudeBord/tableauDeBord.php">Tableau de bord</a></li>
                                <li class="nav-item px-lg-3"><a class="nav-link" href="http://localhost/SAE/Cours/cours.php">Cours</a></li>
                                <li class="nav-item px-lg-3"><a class="nav-link" href="http://localhost/SAE/Forum/questionsForum.php">Forum</a></li>
                            ...
                            <div class="nav-item dropdown ms-lg-auto mt-2 mt-lg-0 text-center">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end dropdown-menu-dark text-center" aria-labelledby="navbarProfil">
                                    <li><a class="dropdown-item" href="http://localhost/SAE/Reglages/informations.php">Mon Compte</a></li>
