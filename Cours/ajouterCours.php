...
<html lang="fr" data-bs-theme="auto">
    ...
    $collectionCours = $mongoDB->cours;

    $resMats = $pdo->query("SELECT Matiere.idM, Matiere.nomM, Formation.nomF FROM Matiere JOIN Formation ON Matiere.idF = Formation.idF");
    $lesMathieres = $resMats->fetchAll(PDO::FETCH_ASSOC);
        ...
        <div class="container">
            <main>
                ...
                <div class="col-md-7 col-lg-8">
                    ...
                    <form class="needs-validation" action="ajouterCours.php" method="POST" enctype="multipart/form-data" novalidate>
                        <div class="row g-3">
