...
try {
    $Connexion = new PDO('mysql:host=10.3.17.220;dbname=ISANET', 'Admin', 'L@SNUM', [
        ...
        try {
            ...
            if ($checkUser->rowCount() > 0) {
                ...
                if ($recupUser->rowCount() > 0) {
                    ...
                    header("Location: http://localhost/projet/index.php"); // Remplacez par la page de votre choix
    ...
    if (!empty($_POST['identifiant']) && !empty($_POST['pwd'])) {
        ...
        if ($recupUser->rowCount() > 0) {
            ...
            if (password_verify($motpasse, $user['Password'])) {
                ...
                header("Location: http://10.3.17.217/TableaudeBord/tableauDeBord.php"); // Remplacez par la page de votre choix
                exit();
            } else {
