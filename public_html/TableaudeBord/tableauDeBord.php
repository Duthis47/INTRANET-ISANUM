            ...
            <div class="col-md-6">
                <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                    <div class="col p-4 d-flex flex-column position-static">
                        ...
                        <br>
                        <a href="http://10.3.17.217/Cours/cours.php?anneeFormation=<?php echo $_SESSION['idF']?>" class="icon-link gap-1 icon-link-hover stretched-link">
                ...
                <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative gradende-bleu">
                    <div class="col p-4 d-flex flex-column position-static">
                        ...
                        <?php if ($event): ?>
                            ...
                            <a href="http://10.3.17.217/Evenements/Evenements.php?idE=<?= $event['idE'] ?>"
            ...
            <div class="col-md-5">
                <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                    <div class="col p-4 d-flex flex-column position-static">
                        ...
                        <a href="http://10.3.17.217/Message/Message.php" class="icon-link gap-1 icon-link-hover stretched-link">
                            Voir plus
                            <svg class="bi" aria-hidden="true">
                                <use xlink:href="#chevron-right"></use>
                            </svg>
