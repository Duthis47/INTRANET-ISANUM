  ...
  <section id="speakers" class="banner speakers">
    ...
    <div class="wrapper position-relative text-center" style="z-index: 2;">
      ...
      <?php if (isset($_SESSION['idU'])) { ?>
          <a href="/Cours/cours.php" class="btn btn-primary btn-lg mt-3">Accéder au site</a>
      <?php } else { ?>
          <a href="/Authentification/login.php" class="btn btn-primary btn-lg mt-3">Se connecter</a>
      <?php } ?>
              ...
              <div class="carousel-caption <?= $index === 0 ? 'text-start' : ($index === 2 ? 'text-end' : '') ?>">
                ...
                <p>
                  <a class="btn btn-lg btn-primary"
                    href="/Evenements/Evenements.php">
                    Voir l’événement
                  </a>
                </p>
              </div>
